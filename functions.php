...
// Thumbnail sizes
add_image_size( 'mainlead_feat', 1140, 612, true );
add_image_size( 'wpbs-featured', 1140, 612, true );
...
function wp_bootstrap_page_navi($before = '', $after = '') {
  ...
  if ($paged > 1) {
    ...
    echo '<li class="prevpagination"><a href="'.get_pagenum_link().'" title="' . __('First','wpbootstrap') . '">'.$first_page_text.'</a></li>';
  }
    
  $prevposts = get_previous_posts_link( __('&larr;','wpbootstrap') );
  if($prevposts) { echo '<li class="prevpagination">' . $prevposts  . '</li>'; }
  else { echo '<li class="disabled"><a href="#">' . __('&larr;','wpbootstrap') . '</a></li>'; }
  ...
  echo '<li class="nextpagination">';
  next_posts_link( __('&rarr;','wpbootstrap') );
  echo '</li>';
  if ($end_page < $max_page) {
    $last_page_text = "&raquo;";
    echo '<li class="nextpagination"><a href="'.get_pagenum_link($max_page).'" title="' . __('Last','wpbootstrap') . '">'.$last_page_text.'</a></li>';
  }
  echo '</ul>'.$after."";
}
